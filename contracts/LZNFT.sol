...
contract LZNFT is Ownable,ERC721Enumerable {
    ...
    constructor(address receiver,address usdtAddress) ERC721("LZNFT", "LZNFT") Ownable(){
    ...
    event Mint(address minter,uint256 nftId,uint256 feeType,uint256 mintFee,uint256 id);
